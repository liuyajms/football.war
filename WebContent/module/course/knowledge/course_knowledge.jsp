...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">
			<fmt:message key="course_my.th1" bundle="${course}" />
		</h3>
	</div>
	...
	<table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead >
			<tr>
				...
				<th name="name">
					<fmt:message key="course_my.th1.name" bundle="${course}" />
				</th>
				<th name="description">
					<fmt:message key="course_my.th1.description" bundle="${course}" />
				</th>
			</tr>
		</thead>
		<tbody />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		initRowCheck($("#table"));
		richedit = initRichedit("description", '300px');
