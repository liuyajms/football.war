	...
	<table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead>
			<tr>
				...
				<th name="title"><fmt:message key="broadcast.title" bundle="${broadcast}" /></th>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" id="form" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="voice">
							<fmt:message key="broadcast.voice" bundle="${broadcast}" />
						</label> <input type="file" id="voice" name="voice" /> <input type="hidden"
...
<script type="text/javascript">
	...
	function viewComment(id) {
		window.location = "<a href=\"javascript:menu('comment.jsp');\"></a>";
	}
