...
public class Session2 {
	...
	public static Session2 getInstance(String id) {
		return new Session2(id);
	}
    ...
    public static void setMemcachedClient(MemcachedClient memcachedClient) {
        Session2.memcachedClient = memcachedClient;
    }
	...
	public <T extends Serializable> Session2 set(String k, T v) {
		if (getId() == null) {
			return null;
		}
