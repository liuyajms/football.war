...
//			Set<String> keyWordSet = readSensitiveWordFile();
	...
	private Set<String> readSensitiveWordFile() throws Exception{
		...
		File file = new File("E:\\zxcx\\2014-10\\10.31\\SensitiveWord.txt");    //读取文件
	...
	//从数据库读取敏感字
	private Set<String> readSensitiveWordDB() throws Exception {
		...
		try {
			...
			session = ServiceFactory.getSession().openSession();

			List<Sensitive> list = session.getMapper(SensitiveMapper.class)
					.getSqlList("select * from sensitive where available is true");
